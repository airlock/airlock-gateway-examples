...
# In order for this script to work, create a folder named 
# 'airlock_gateway_rest_api_lib' in the same folder as this script,
# then add the REST API library Python file (available at 
# https://github.com/ergon/airlock-gateway-rest-api-lib-py) to the 
